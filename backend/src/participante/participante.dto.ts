...
export const AtualizarParticipanteSchema = CriarParticipanteSchema.omit({ cpf: true }).partial();

export type CriarParticipanteDto = z.infer<typeof CriarParticipanteSchema>;
export type AtualizarParticipanteDto = z.infer<typeof AtualizarParticipanteSchema>;
